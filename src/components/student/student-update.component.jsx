...
class StudentUpdate extends Component {
  ...
  componentDidMount() {
    ...
    const { fetchStudentByIdDispatch, studentToUpdate } = this.props;
    const studentId = this.props.match.params.studentId;
    fetchStudentByIdDispatch(studentId);
    console.log("filter", studentToUpdate);
  }
  ...
  initialize(nextProps) {
    const studentToUpdate = nextProps.studentToUpdate;

    console.log("nextProps", nextProps);
    console.log("nextProps", nextProps.studentToUpdate);
    console.log("studentToUpdate", studentToUpdate);

    alert("stop");
    this.setState({ studentDetails: studentToUpdate });
  }
  ...
  handelSubmit = (event) => {
    ...
    const { updateStudentDispatch } = this.props;
    const { studentDetails } = this.state;
    updateStudentDispatch(studentDetails);
  };
  render() {
    const { studentDetails } = this.state;
    ...
    alert("stop to check studentDetails");
    return (
            ...
            <div className="card-body">
              <form name="form" onSubmit={this.handelSubmit}>
                <div className="row clearfix">
                  ...
                  <SubmitButton buttonName={"Update Student"} />
                </div>
              </form>
            </div>
          </div>
...
const mapStateToProps = createStructuredSelector({
  ...
  studentByIdError: selectStudentByIdErrorMessage,
});

const mapDispatchToProps = (dispatch) => ({
  fetchStudentByIdDispatch: (studentId) =>
    dispatch(fetchStudentByStudentIdUpdateStart(studentId)),
  updateStudentDispatch: (studentToUpdate) =>
    dispatch(updateStudent(studentToUpdate)),
});
